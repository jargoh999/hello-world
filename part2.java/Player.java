...
public class Player {
    ...
    public void play(TicTacToe ticTacToe,int rowPlayed,int columnPlayed){
        if(isValidTile(ticTacToe,rowPlayed,columnPlayed)) ticTacToe.getValueInCells()[rowPlayed][columnPlayed]=this.playerSignature;
    }
    ...
    public void play(TicTacToe ticTacToe,int tileToPlay){
         if (tileToPlay > 0 && tileToPlay <= 9 ) {
             if (tileToPlay == 1){play(ticTacToe,0,0);}
             if (tileToPlay == 2){play(ticTacToe,0,1);}
             if (tileToPlay == 3){play(ticTacToe,0,2);}
             if (tileToPlay == 4){play(ticTacToe,1,0);}
             if (tileToPlay == 5){play(ticTacToe,1,1);}
             if (tileToPlay == 6){play(ticTacToe,1,2);}
             if (tileToPlay == 7){play(ticTacToe,2,0);}
             if (tileToPlay == 8){play(ticTacToe,2,1);}
             if (tileToPlay == 9){play(ticTacToe,2,2);}
         }
         else {
