...
System.out.printf ( "%s car costs %.2f is now for sale on discount for %.2f%n",car1.getModel(), car1.getPrice(), car1discount); 


System.out.printf ( "%s car costs %.2f is now for sale on discount for %.2f",car2.getModel(), car2.getPrice(), car2discount); 
